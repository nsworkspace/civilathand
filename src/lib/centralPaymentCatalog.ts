...
export const CENTRAL_PAYMENT_SEEDS: CentralPaymentSeed[] = [
  { slug: "vendor-registration", active: true, title: "Vendor Network Registration", description: "Vendor registration and onboarding fee for suppliers, contractors, fabricators, manpower providers and specialist service businesses joining the Civil At Hand Vendor Network. Registration supports professional listing and review; it does not guarantee projects or work.", category: "vendor-registration", amount: 99, pageHint: "Vendor Network / Registration", accessType: "vendor-registration", accessValue: "vendor-registration" },
