...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!vendor) return { title: "Vendor Not Found | NS Construction", robots: { index: false, follow: true } };
  ...
  return {
    title: `${name} | ${capability} | NS Construction`,
    description: `${name} — ${capability} in ${location}. Discover the business profile and request a project introduction through NS Construction.`,
...
export default async function VendorDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const jsonLd = {
    ...
    "@type": "Organization",
    name,
    description: vendor.description || `${vendor.category || vendor.vendorType} services listed on NS Construction.`,
