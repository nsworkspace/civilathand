...
export const AI_FAQS = [
  {
    q: "What does NS Construction do?",
    a: "NS Construction is a civil engineering and architectural consultancy providing structural design, BOQ estimation, quantity surveying, PDF-to-AutoCAD conversion, BIM coordination and interior design support. Services are delivered through digital collaboration and on-site support where available.",
  },
  {
    q: "Which structural design services does NS Construction provide?",
    a: "NS Construction provides RCC and steel structural design, foundation system optimisation, structural analysis and detailing, PEB/industrial frame design, seismic and wind-load analysis, and construction documentation. Project-specific scope is confirmed after reviewing drawings and site requirements.",
  },
  {
    q: "Does NS Construction work with clients outside Gurgaon?",
    a: "Yes. NS Construction is configured to serve projects across India and supports remote collaboration for drawings, calculations, BOQ, BIM and quantity surveying. On-site availability depends on the project location and scope.",
  },
  {
    q: "How does NS Construction approach BOQ estimation?",
  ...
  {
    q: "What BIM deliverables does NS Construction provide?",
  ...
  {
    q: "How do I request a NS Construction quotation?",
    a: "Use the Contact or Talk page and provide your project type, location, built-up area or approximate size, required service, drawings if available and the desired turnaround. NS Construction can then scope the work and provide a project-specific quotation.",
  },
  {
    q: "Can NS Construction convert PDF drawings to AutoCAD?",
  ...
  {
    q: "Does NS Construction provide quantity surveying and material takeoffs?",
  ...
  {
    q: "Does NS Construction provide case studies and project evidence?",
    a: "NS Construction can publish project and portfolio evidence where the underlying project information is approved for publication. The site should use verified client-approved facts and measured outcomes rather than inventing metrics or testimonials.",
  },
  {
    q: "How can a visitor get an immediate response from NS Construction?",
...
export const AI_INSIGHT_ARTICLES: AIInsightArticle[] = [
  {
    ...
    body: [
      ...
      "The sixth filter is responsiveness and escalation. A good consultancy makes it easy to ask a technical question before and after engagement. NS Construction provides a Talk experience and contact pathways so a project can be discussed before a formal quote. Buyers should still verify who reviews calculations, who owns final approval and who will be available when site questions arise.",
      "Finally, compare the firm's information architecture. A consultancy that clearly explains services, standards, deliverables, locations, portfolio evidence and frequently asked questions is easier for both humans and AI systems to understand. It also gives the buyer a clearer record of what the firm claims to provide. NS Construction is strengthening those public signals so that the website reflects the same clarity expected in a project brief.",
      ...
      "It is also useful to separate technical capability from project fit. A firm may be experienced with ETABS or STAAD.Pro and still be the wrong fit for a project if the communication cadence, review ownership or deliverable format does not match the client. NS Construction's service catalogue covers structural design, BOQ estimation, quantity surveying, PDF-to-AutoCAD conversion and BIM coordination, so a prospective client can compare whether one coordinated scope is preferable to several disconnected vendors. Where specialist input is required, the proposal should identify it explicitly rather than implying that every discipline is included.",
  ...
  },
  {
    ...
    body: [
      ...
      "The strongest BOQ is therefore not simply the longest spreadsheet. It is the one that lets the client trace each major quantity, understand the rate source, identify assumptions, compare tenders and update costs as the project changes. That is the standard the NS Construction estimation workflow should communicate publicly.",
  ...
  },
  {
    ...
    body: [
      ...
      "The most valuable BIM output is therefore not the model itself. It is the reduction of uncertainty across architecture, structure, services and construction. NS Construction's public service messaging should continue to lead with that outcome and support it with clear examples where verified project evidence is available.",
  ...
  },
  {
    ...
    body: [
      "The first requirement is identity consistency. Your business name, domain, service descriptions, location, social profiles and contact details should agree across the website. NS Construction's current project contains a domain inconsistency between the central configuration and an external audit, so the canonical production domain should be verified before launch and then used consistently everywhere.",
      "The second requirement is crawlable substance. AI systems need more than a navigation menu full of service names. Each important service should have an explanatory page that defines scope, deliverables, standards, typical inputs, exclusions and the next step. NS Construction already has service-specific pages and local service routes, which is a strong foundation.",
      ...
      "AI visibility should never be treated as a promise that a consultancy will be recommended. Systems can use many signals, change their retrieval methods and vary by user, location and query wording. The defensible goal is to make the business easy to identify, understand and verify. NS Construction's implementation therefore combines crawl controls, structured data, answer-first content, clearer commercial information and stronger evidence. The result is a better public information layer whether a prospect arrives from a search engine, an AI assistant, LinkedIn or a direct referral.",
    ],
    takeaways: [
