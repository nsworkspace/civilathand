  ...
  return <div className="space-y-6">
    <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-white via-white to-orange-50/50 p-5 sm:p-7 shadow-sm">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div><div className="inline-flex items-center gap-2 rounded-full bg-orange-50 px-3 py-1.5 text-[9px] font-extrabold uppercase tracking-[0.16em] text-orange-700"><BookOpen className="h-3.5 w-3.5" /> Premium Education Library</div><h3 className="mt-4 font-display text-2xl font-black tracking-tight text-slate-950">Upload Civil At Hand Study Material</h3><p className="mt-2 max-w-2xl text-xs leading-6 text-slate-500">Upload your original PDF, define the unit structure and choose the selling price. The PDF is stored in MongoDB GridFS and is never exposed as a public file URL.</p></div>
