// ============================================================
// SHARED SOCIAL ICONS
// PLACE AT Here: src/components/icons/SocialIcons.tsx
//
// These were previously copy-pasted three separate times, once
// each in Header.tsx, Footer.tsx, and (informally) the old
// /links page. One icon set lives here now — Header, Footer and
// the Links page all import from this single file. If you ever
// need to fix or restyle an icon, you now only do it in one place.
// ============================================================
...
export const LinktreeIcon = (props: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
// Whatsapp isn't in Header/Footer today, but is a headline action on
// the Links page (and the site's primary contact channel), so it
// gets a matching hand-drawn icon in the same stroke language.
export const WhatsAppIcon = (props: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.01 2C6.48 2 2 6.48 2 12c0 1.86.5 3.6 1.38 5.1L2 22l5.06-1.33A9.93 9.93 0 0 0 12.01 22C17.53 22 22 17.52 22 12S17.53 2 12.01 2zm0 18.1c-1.67 0-3.23-.47-4.55-1.28l-.33-.2-3 .79.8-2.93-.21-.31A8.07 8.07 0 0 1 3.9 12c0-4.47 3.64-8.1 8.11-8.1s8.1 3.63 8.1 8.1-3.63 8.1-8.1 8.1zm4.44-6.05c-.24-.12-1.43-.7-1.65-.79-.22-.08-.38-.12-.55.12-.16.24-.63.79-.77.95-.14.16-.28.18-.52.06-.24-.12-1.02-.38-1.94-1.2-.72-.64-1.2-1.43-1.34-1.67-.14-.24-.02-.37.11-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.55-1.33-.76-1.82-.2-.48-.4-.42-.55-.42-.14-.01-.3-.01-.46-.01-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2s.86 2.32.98 2.48c.12.16 1.7 2.6 4.13 3.64.58.25 1.03.4 1.38.51.58.18 1.11.16 1.53.1.47-.07 1.43-.58 1.63-1.15.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28z" />
  </svg>
);
