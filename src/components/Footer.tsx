...
const learningLinks = [
  { label: "Learning hub", href: "/education", icon: GraduationCap },
  { label: "Courses", href: "/education/courses", icon: FileText },
  { label: "Study materials", href: "/education/study-materials", icon: FileText },
        ...
        <div className="relative mx-auto max-w-[1500px] px-5 pb-[calc(22px+env(safe-area-inset-bottom))] pt-10 sm:px-7 sm:pt-12 lg:px-10 lg:pt-14">
          <div className="grid gap-12 lg:grid-cols-[minmax(280px,1.05fr)_minmax(0,2.95fr)] lg:gap-14 xl:gap-20">
            <div className="max-w-[390px]">
              ...
              <p className="mt-8 max-w-[360px] text-[15px] leading-7 text-slate-300 sm:text-[16px]">Learn civil engineering and architecture through practical courses, study material, mentorship, careers and industry knowledge.</p>
            ...
            <nav aria-label="Footer navigation" className="grid grid-cols-1 gap-x-7 gap-y-11 sm:grid-cols-2 xl:grid-cols-4">
              <FooterGroup title="Company" links={companyLinks} />
              <FooterGroup title="Learning" links={learningLinks} />
