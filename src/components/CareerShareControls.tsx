  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
      ...
      <div className="flex gap-2">
        ...
        <a href={`https://wa.me/?text=${encodeURIComponent(`${title} at NS Construction — ${url}`)}`} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-lg bg-emerald-500 text-white px-3 py-2"><ExternalLink className="h-3.5 w-3.5" /></a>
      </div>
    </div>
  );
}
